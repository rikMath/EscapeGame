...
unrealRootPath=/home/henrique/Documentos/unreal_engine/UnrealEngine
EscapeGameRootPath=/home/henrique/Documentos/unreal_engine/projects/EscapeGame

gameProjectFile=/home/henrique/Documentos/unreal_engine/projects/EscapeGame/EscapeGame.uproject
...
include(EscapeGameSource.pri)
include(EscapeGameHeader.pri)
include(EscapeGameConfig.pri)
include(EscapeGameIncludes.pri)
include(EscapeGameDefines.pri)

EscapeGame-Linux-Debug.commands = $$build EscapeGame Linux Debug  -project="\"$$gameProjectFile\"" $$args
EscapeGame-Linux-DebugGame.commands = $$build EscapeGame Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
EscapeGame-Linux-Shipping.commands = $$build EscapeGame Linux Shipping  -project="\"$$gameProjectFile\"" $$args
EscapeGame-Linux-Test.commands = $$build EscapeGame Linux Test  -project="\"$$gameProjectFile\"" $$args
EscapeGame.commands = $$build EscapeGame Linux Development  -project="\"$$gameProjectFile\"" $$args

EscapeGameEditor-Linux-Debug.commands = $$build EscapeGameEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
EscapeGameEditor-Linux-DebugGame.commands = $$build EscapeGameEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
EscapeGameEditor-Linux-Shipping.commands = $$build EscapeGameEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
EscapeGameEditor-Linux-Test.commands = $$build EscapeGameEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
EscapeGameEditor.commands = $$build EscapeGameEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	EscapeGame-Linux-Debug \
	EscapeGame-Linux-DebugGame \
	EscapeGame-Linux-Shipping \
	EscapeGame-Linux-Test \
	EscapeGame \
	EscapeGameEditor-Linux-Debug \
	EscapeGameEditor-Linux-DebugGame \
	EscapeGameEditor-Linux-Shipping \
	EscapeGameEditor-Linux-Test \
	EscapeGameEditor \
