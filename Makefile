...
EscapeGame-Linux-Debug:
	 $(PROJECTBUILD) EscapeGame Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeGame-Linux-DebugGame:
	 $(PROJECTBUILD) EscapeGame Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeGame-Linux-Shipping:
	 $(PROJECTBUILD) EscapeGame Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeGame-Linux-Test:
	 $(PROJECTBUILD) EscapeGame Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeGame:
	 $(PROJECTBUILD) EscapeGame Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeGameEditor-Linux-Debug:
	 $(PROJECTBUILD) EscapeGameEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeGameEditor-Linux-DebugGame:
	 $(PROJECTBUILD) EscapeGameEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeGameEditor-Linux-Shipping:
	 $(PROJECTBUILD) EscapeGameEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeGameEditor-Linux-Test:
	 $(PROJECTBUILD) EscapeGameEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeGameEditor:
	 $(PROJECTBUILD) EscapeGameEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
